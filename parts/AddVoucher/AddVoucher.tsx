...
// Components
import { Chip, Grid, ListItem, Stack } from "@mui/material";
					...
					<Grid item xs={12} md={6}>
						<Grid container spacing={{ xs: 2, md: 3 }} sx={{ ml: { xs: -2 } }}>
							...
							<Grid item xs={12}>
								...
								<Grid item container xs={12} spacing={{ xs: 1, sm: 2, md: 3 }}>
									<Grid item xs={scope === "User" ? 7 : 12} sm={scope === "User" ? 9 : 12}>
										<SelectInput options={["Global", "User"]} value={scope} />
									</Grid>
									{scope === "User" && (
										<Grid item xs={5} sm={3}>
											<Button
